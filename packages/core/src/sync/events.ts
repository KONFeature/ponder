...
import type { RawBlockEvent } from "./index.js";
 ...
 *
 * Note: This function doesn't support factories yet
 */
export const buildEvents = (
  sources: Source[],
  { block, logs, transactions, transactionReceipts, callTraces }: RawBlockEvent,
) => {
